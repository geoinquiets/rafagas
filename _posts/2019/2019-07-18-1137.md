...
rafagas:
- desc: watercolor
  keyw: A gallery shows hand-painted watercolor maps by @Junevgt
  ...
  microlink:
    ...
    title: Stinarto
- desc: washington
  keyw: An 1827 map shows directions from Washington to more than 130 world cities
    and harbors
  ...
  microlink:
    ...
    title: Compendious chart exhibiting, at one view, the names of about thirteen
      ...
      of Washington
- desc: population
  keyw: A three.js map created using QGIS shows USA population density on a 10km grid
  ...
  microlink:
    ...
    title: index
- desc: movies
  keyw: Cinemaps is an atlas for 35 movies showing their characters wanderings
